...
showDialog = (function() {
	var j = [],
		...
		isIE7 = (/MSIE 7.0/ig.test(navigator.appVersion)),
	...
	function setOpacity(e, a) {
		return (isIE && !isIE10) ? (e.style.filter = 'Alpha(opacity=' + a + ')') : (e.style.opacity = a / 100)
	}
	...
	return {
		...
		overlay: function() {
			...
			if (isIE7) {//ie7遮罩问题
				var q = gEl("file_upload-queue");
				if(typeof q != undefined && q != null){
					var main = gEl("main");
					var main_wrap = gEl("main_wrap")
					main.insertBefore(q,main_wrap);
				}
				
				var q = gEl("file_upload_text-queue");
				if(typeof q != undefined && q != null){
					var main = gEl("main");
					var main_wrap = gEl("main_wrap")
					main.insertBefore(q,main_wrap);
...
})(); /*  |xGv00|485928a42275a027816ac4a7f1cc8299 */
